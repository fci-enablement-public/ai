...
printf "%-30s%-30s\n" "Configure LDAP client 1/6" "Install an LDAP client like Softerra LDAP Browser or ldapsearch (e.g., yum install openldap-clients)"
...
printf "%-30s%-30s\n" "Configure LDAP client 4/6" "On the Kubernetes master, run this command: cat ${base}/ldap.crt"
